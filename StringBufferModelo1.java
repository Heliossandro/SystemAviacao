...
public class StringBufferModelo1 extends ObjectSerializableGeneric
{
	private StringBuffer buffer;

	public StringBufferModelo1(String name, int size)
	{
		buffer = null;
	...
	public StringBufferModelo1(int size)
	{
		buffer = new StringBuffer( size );
		buffer.setLength( size );
